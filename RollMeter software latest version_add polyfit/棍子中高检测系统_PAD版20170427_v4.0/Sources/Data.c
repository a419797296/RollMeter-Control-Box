...
int PAD_RT_AD(void)                   
{
   ...
   /*  tmp_AD=AD_capture(0);
     ...
     tmp_AD=tmp_AD*FIRST_ORDERE/10000-CONSTANT_ORDERE;
...

{
     /*  sens_AD=AD_capture(0);
      ...
      /* if(point.y-sens_AD<=Threshold||sens_AD-point.y<=Threshold)      //阀值滤波
       ...
       point.y= sens_AD*FIRST_ORDERE/10000-CONSTANT_ORDERE;   
